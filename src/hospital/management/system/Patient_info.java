...
public class Patient_info extends JFrame {
    ...
    Patient_info() {
        ...
        JLabel titleLabel = UITheme.createTitleLabel("Ã°Å¸â€œâ€¹ Patient Information");
        ...
        UITheme.setupFrame(this, "MediCare HMS - Patient Information", 950, 600);
        setVisible(true);
    }

    public static void main(String[] args) {
        UITheme.installTheme();
        SwingUtilities.invokeLater(Patient_info::new);
    }
}
