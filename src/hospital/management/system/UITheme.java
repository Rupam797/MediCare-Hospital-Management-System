...
/**
 * UITheme — Centralized Design System for MediCare HMS
 * 
...
public class UITheme {
    ...
    /**
     * Creates a gradient background panel (BG_PRIMARY → BG_SECONDARY).
     */
    ...
    /**
     * Standard frame setup — centers on screen, sets dark background, title, icon.
     */
